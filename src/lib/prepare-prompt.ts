...
export const prepareFirstPrompt = (
  userMsg: string = "Show me cool things happening now. My interests are: MPLS, SD-WAN and Telecommunications"
) => `
# Context
...
- If you use information from context please provide provide the source.
